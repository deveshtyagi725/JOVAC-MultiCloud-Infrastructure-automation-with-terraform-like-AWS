...
## 📘 **Overview**
> **JOVAC (Joint Operations Virtual Automation Cloud)** is an **AI-engineered Terraform project** that delivers *multi-cloud-ready infrastructure automation* on **AWS**.  
